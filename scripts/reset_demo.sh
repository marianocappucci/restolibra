#!/usr/bin/env bash
# Reset diario de la demo publica de Restolibra — item 8 de los pendientes de
# Libra.
#
...
#
# 🔴 **Solo toca la instancia publica.** El contenedor esta escrito aca, no
...
docker cp "/root/restolibra/scripts/seed_demo.py" "$CONTENEDOR:/tmp/seed.py"
