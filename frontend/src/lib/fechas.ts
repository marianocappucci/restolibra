 ...
 *
 * Antes de este archivo el producto tenia CUATRO formateadores sueltos
 * (`formatDate` en Dashboard, `aFechaLocal` y `horaDe` en Logs, `sinSegundos`
 * en Turnos) y una docena de pantallas que imprimian el ISO crudo. Una
 * constante copiada en N lugares es divergencia esperando a pasar.
 */
